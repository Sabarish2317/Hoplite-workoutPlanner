...
//           String date = historyData.dateTime;
//           String splitName = historyData.values[0];
//           String dayName = historyData.values[1];
//           Map<int, WorkoutDetail> modifiedExerciseList = historyData.values[2];
